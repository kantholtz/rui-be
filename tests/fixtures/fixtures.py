...
node_aa = DeepNode(id=1, parent_id=0, entities=[entity_aa1], children=[])

entity_ab1 = Entity(id=2, node_id=2, name='Ab-1', matches_count=2)
node_ab = DeepNode(id=2, parent_id=0, entities=[entity_ab1], children=[])

entity_a1 = Entity(id=0, node_id=0, name='A-1', matches_count=2)
node_a = DeepNode(id=0, parent_id=None, entities=[entity_a1], children=[node_aa, node_ab])
...
node_bb = DeepNode(id=5, parent_id=3, entities=[entity_bb1, entity_bb2], children=[])

entity_b1 = Entity(id=3, node_id=3, name='B-1', matches_count=1)
node_b = DeepNode(id=3, parent_id=None, entities=[entity_b1], children=[node_ba, node_bb])

### Node C

entity_c1 = Entity(id=11, node_id=6, name='C-1', matches_count=1)
node_c = DeepNode(id=6, parent_id=None, entities=[entity_c1], children=[])
